...
class Preprocess:
    ...
    def __init__(self, directory_path, filetype, tfrecord_image, tfrecord_label, loss_function=None, train=True):
        """
    ...
    def __get_lists(self):
        ...
        labels = tf.one_hot(tf.dtypes.cast(labels, tf.uint8), label_number)
